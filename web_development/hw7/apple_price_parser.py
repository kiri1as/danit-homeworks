...
def update_products_data(scheduled=False):
    print(f'{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}: --- PROCESSING PRODUCTS PRICES STARTED ---')
    ...
    print(f'{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}: --- PROCESSING PRODUCTS PRICES ENDED ---')
